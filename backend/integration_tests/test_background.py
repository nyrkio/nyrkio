...
class RestClient():
    ...
    def actual_login(self):
        ...
        resp = self.post("/api/v0/auth/jwt/login",
...
def test_one_deep_summary(client, username="albert@example.com"):
    ...
    expected = {'a/b/c/d/e/f': {'largest_change': 100.0,
                 'largest_change_point': {'forward_change_percent': '100',
                                          'index': 2,
                                          'magnitude': '1.000000',
                                          'pvalue': '0.000000',
                                          'time': 3},
                 'largest_test_name': 'a/b/c/d/e/f',
                 'oldest_change_point': {'forward_change_percent': '100',
                                         'index': 2,
                                         'magnitude': '1.000000',
                                         'pvalue': '0.000000',
                                         'time': 3},
...
def test_treelike_hierarchy_summary(client, username="ebba@example.com"):
    ...
    expected = {'a/b/c/d/e/f': {'largest_change': 100.0,
                 'largest_change_point': {'forward_change_percent': '100',
                                          ...
                                          'time': 4},
                 'largest_test_name': 'a/b/c/d/e/f',
                 'newest_change_point': {'forward_change_percent': '100',
                                         'index': 3,
                                         'magnitude': '1.000000',
                                         'mean_after': '2.000000',
                                         'mean_before': '1.000000',
    ...
    assert response.status_code == 200
    json = response.json()
    expected = {'a/b/c/d/e': {'largest_change': 100.0,
               'largest_change_point': {'forward_change_percent': '100',
                                        'index': 3,
                                        'magnitude': '1.000000',
                                        'mean_after': '2.000000',
               ...
               'oldest_time': 4,
               'total_change_points': 1},
 'a/b/c/d/emil': {'largest_change': 800.0,
                  'largest_change_point': {'forward_change_percent': '800',
                                           'index': 1,
                                           'magnitude': '8.000000',
                  ...
                  'newest_change_point': {'forward_change_percent': '800',
                                          'index': 1,
                                          'magnitude': '8.000000',
                                          'mean_after': '900.000000',
                                          'mean_before': '100.000000',
                  ...
                  'newest_time': 2,
                  'oldest_change_point': {'forward_change_percent': '800',
                                          'index': 1,
                                          'magnitude': '8.000000',
                                          'mean_after': '900.000000',
                                          'mean_before': '100.000000',
    ...
    assert response.status_code == 200
    json = response.json()
    expected = {'a/b/c/d': {'largest_change': 800.0,
             'largest_change_point': {'forward_change_percent': '800',
                                      'index': 1,
                                      'magnitude': '8.000000',
                                      'mean_after': '900.000000',
