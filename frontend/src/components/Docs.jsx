  ...
  return (
    <>
      <div>
        ...
        <p>This guide will show you how to get started with Nyrkiö.</p>

        <p>
          All of the examples in this doc use `curl` but you can use your
          favourite language and libraries for sending HTTP requests.
        </p>
        ...
        <p>
          The easiest and recommended option is to just click on the Github
          button on the top and you're done.
        </p>
