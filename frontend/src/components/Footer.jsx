...
export const Footer = () => {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="d-none">
      ...
      <RssWidget />
      <div id="footerwrapper" className="container-fluid top pt-0 g-0 px-0 footer justify-content-center">
      ...
      <img src={footerUpperCrust} style={{position: "relative", top: "-5px", width: "100%"}}/>
          ...
          <ul className="nav">
                ...
                <li className="ms-2">
                  ...
                  >
     f               <svg className="bi" width="24" height="24">
              ...
              <footer className="row my-4 " style={{align: "right"}}>
              <div className="row p-3 mt-5">
                <span
                  className="mb-3 text-body-secondary"
                >
                  &copy; 2026  Nyrkiö Oy<br /><br />
              ...
              <div className="row p-3 mt-5">
                <span
                  className="mb-3 text-body-secondary"
                >
                  @nyrkio/change-detection GitHub action is based on the <a href="https://github.com/benchmark-action/github-action-benchmark">Github-Action-Benchmark project</a>.
