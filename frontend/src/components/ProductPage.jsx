  ...
  return (
    <>
      ...
      <div className="row p-2 col-md-10">
        ...
        <p>
          Running automated unit and integration tests in Continuous Integration
          is nothing new. But on the performance testing front, it's been a
          slower shift. Automating large scale performance workloads so they can
          be scheduled automatically at night is both harder, but above all more
          expensive, than simple unit testing. Yet the days when performance
          testing mostly meant an annual rush to test the new release candidates
          are gone. Increasingly all serious software development teams do run
          nightly performance tests, and sometimes even before merging.
        </p>
      ...
      <div className="row p-2 col-md-10">
        <div className="col-xl-4 col-xs-12 p-2">
          <h3>The hard way</h3>
          <p>
            Unlike unit and other correctness tests, the result of a performance
            benchmark is not a simple pass or fail, wrong or correct.
            Benchmarking produces a number, or several, and the sequence of
            nightly builds produces a timeseries. But what should we do - and
            how should we automate - to analyze hundreds of nightly numeric
            values?
          </p>

          <p>
            The common approach is to simply continue what you have done before:
            The performance engineer will look at - yes, eyeballing - hundreds
            of metrics on half a dozen Grafana dashboards, and in their wisdom
            declare that performance <i>"looks good to me"</i>.
          </p>
        </div>
      ...
      <div className="row p-0 col-md-10">
        ...
        <p>
          ...
          noise varies by application and test, but it is not unusual for a test
          to fluctuate between a 5-10% window. On the other hand some tests can
          be remarkably stable, so that anything above a 1% change stands out.
        </p>
      </div>
      <div className="row col-md-10 col-xs-12 p-0">
        ...
        <div className="col-xl-6 col-xs-12 p-2">
          <p>
            ...
            than last week, should the build be marked failed or not? That would
            depend on the test and its history. But there's more: What if the
            regression is just 3%, but then another 3% the next week?
          </p>

          <p>
            It is at this point that the valuable time of a skilled performance
            engineering team is wasted in an effort to by hand maintain a
            ruleset of thresholds and variance levels. Experience shows this
            simple idea turns into a losing battle. Even assigning a full time
            engineer will not help, and the nightly performance tests continue
            to have a high degree of both false positives and negatives.
          </p>
        </div>
      </div>
      <div className="row col-md-10 col-xs-12">
        ...
        <p>
          ...
          compare against a mean of recent results, also taking into account the
          standard deviation of each individual history of metrics.
        </p>
        ...
        <p>
          ...
          (2018/0150373 A1, Filed Nov. 28, 2016). This appears to already add
          robustness compared to comparison of two individual points. However,
          if a regression is found this way, it's a limitation that the system
          will only identify a window where the regression was introduced, it is
          unable to identify a specific commit that causes the regression.
        </p>
      </div>
      <div className="row col-md-10 p-2">
        <div className="col">
          ...
          <p>
            ...
            by bringing to general consumption a technique we've found superior
            to all of the above methods.
          </p>
        </div>
      ...
      <div className="row col-md-10 p-2">
        <div className="col">
          <p>
            ...
            part of Continuous Integration is the right way to catch regressions
            as they happen.
          </p>
          <p>
            However, this is only feasible and scalable with sophisticated
            Change Point Detection algorithms that can reliably detect
            regressions and improvements with minimal human effort (per build).
          </p>
        </div>
      </div>
      <div className="row col-md-10 p-2">
      ...
      <div className="row col-md-10 p-2">
        <div className="col">
          ...
          <p>
            ...
            performance engineering teams since 2015,and graciously open sourced
            by both companies for the benefit of all of us. In the past years a
            small community of practitioners have grown around the open source
            project. For example{" "}
            ...
            , as well as Confluent and Hazelcast...
          </p>
          <p>
            And with Nyrkiö, we aim to make this knowledge and tooling readily
            available to every software engineer. It is time for automated
            performance testing to go mainstream!
          </p>
        </div>
      </div>
